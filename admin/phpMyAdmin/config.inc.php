...
$cfgServers[1]['stduser'] = 'stefanbirk';          // MySQL standard user (only needed with advanced auth)
$cfgServers[1]['stdpass'] = 'stbk199asq';         // MySQL standard password (only needed with advanced auth)
$cfgServers[1]['user'] = 'stefanbirk';             // MySQL user (only needed with basic auth)
$cfgServers[1]['password'] = 'stbk199asq';        // MySQL password (only needed with basic auth)
$cfgServers[1]['only_db'] = 'stefanbirk';       // If set to a db-name, only this db is accessible
