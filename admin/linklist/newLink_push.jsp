...
<sql:preparedStatement id="stmt1" conn="conn1">
	<sql:query>
		INSERT INTO linklistLink (category_id, title, message, mod, link)
		VALUES (?, ?, ?, ?, ?)
	</sql:query>
	<sql:execute>
		...
		<sql:setColumn position="4"><%=request.getParameter("mod")%></sql:setColumn>
		<sql:setColumn position="5"><%=request.getParameter("link")%></sql:setColumn>
	</sql:execute>
