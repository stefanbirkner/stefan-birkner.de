...
/*
  ...
  $Id: insert_genre.php,v 1.2 2001/09/16 11:46:41 thomyschneider Exp $
*/
...
print_left_menu("ADMIN", "INSERT_GENRE", "");
...
if ( $admin_is_valid == 0 ) {
  ...
  if ($sent) {
    if ($clear) {
      ...
      if ( insert_genre($form_genre_name) == 1 ) {
	$form_genre_name="";
      }
    }
  }
 ...
 <FORM method="post" action="<?PHP echo $PHP_SELF ?>">
    <BR><CENTER><H2><?PHP } echo $strAdminInsertGenreTopTitle; { ?></H2><HR width="50%"></CENTER><BR>
